...
const verifier = fs.readFileSync(path.join(root, "deployment-v20/verify-deployment-v20.js"), "utf8");
...
console.log("V20 Revenue Staking benchmark split passed: 33% Treasury + 7% admin-role fee on excess; admin is the sole non-Treasury fee.");
