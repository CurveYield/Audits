...
const {
  buildAbiInventory,
  CoverageLedger
} = require("./simulation-v20/coverage-v20");
const {
  CallExecutor,
  serializeExecutionError
} = require("./simulation-v20/executor-v20");
const { runAbiProbes } = require("./simulation-v20/scenarios-v20");
const {
  prepareYieldEnvironment,
  seedCycleRewards,
  createYieldAdapters
} = require("./simulation-v20/contract-scenarios-v20");
const { runYieldCycle } = require("./simulation-v20/yield-cycles-v20");
const {
  buildSimulationReport,
  writeSimulationReports
} = require("./simulation-v20/report-v20");
...
async function runSimulation(options = {}) {
  ...
  try {
    ...
    reportPaths = writeSimulationReports({
      outputDir: path.join(ROOT, "deployment-output-v20"),
      tag,
      report
    });
