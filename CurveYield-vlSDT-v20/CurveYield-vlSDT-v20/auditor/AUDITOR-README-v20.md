...
This is the current V20 uncompiled source handoff. Begin with `AUDIT-SCOPE-v20.md`, then review the active source, threat model, privilege matrix, test plan, and static-check evidence.
