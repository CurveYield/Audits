...
async function deployLockerFixture() {
  ...
  const AdminAuthority = await ethers.getContractFactory("MockAdminAuthority");
...
describe(" DAO allocation, admin excess share, and temporary emergency redemption", function () {
  ...
  it("lets the DAO sell its reserved boost into a marketplace offer for direct DAO income", async function () {
    ...
    const Payment = await ethers.getContractFactory("MockERC20");
