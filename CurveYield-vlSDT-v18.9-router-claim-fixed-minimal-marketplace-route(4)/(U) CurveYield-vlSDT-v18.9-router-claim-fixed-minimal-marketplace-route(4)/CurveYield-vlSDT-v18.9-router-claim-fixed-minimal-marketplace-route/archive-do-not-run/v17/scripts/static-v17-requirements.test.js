...
const staking = fs.readFileSync(path.join(root, "contracts", "CurveYieldGovernanceStakingV17.sol"), "utf8");
const keeper = fs.readFileSync(path.join(root, "scripts", "proposal-participation-keeper-v17.js"), "utf8");
const payloadBuilder = fs.readFileSync(path.join(root, "scripts", "build-proposal-sync-payload-v17.js"), "utf8");
...
console.log("V17 continuous active-deposit rewards and blended participation requirements satisfied.");
