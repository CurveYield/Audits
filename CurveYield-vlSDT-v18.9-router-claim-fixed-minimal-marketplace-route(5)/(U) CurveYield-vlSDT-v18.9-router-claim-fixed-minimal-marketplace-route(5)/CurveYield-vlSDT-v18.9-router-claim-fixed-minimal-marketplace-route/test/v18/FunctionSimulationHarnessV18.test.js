...
const {
  ...
  buildAbiInventory,
  canonicalSignature
} = require("../../deployment-v18/simulation-v18/coverage-v18");
const {
  CallExecutor,
  decodeRevert,
  serializeExecutionError
} = require("../../deployment-v18/simulation-v18/executor-v18");
const { ethers } = require("../../deployment-v18/lib-v18");
...
const {
  ...
  rpcBlock,
  runYieldCycle
} = require("../../deployment-v18/simulation-v18/yield-cycles-v18");
const {
  synthesizeArguments,
  buildScenarioPlan,
  withSnapshot,
  runAbiProbes
} = require("../../deployment-v18/simulation-v18/scenarios-v18");
const {
  extractTransferRecipients,
  pendingImpersonatedOverrides,
  isRetryableForkTransportError
} = require("../../deployment-v18/simulation-v18/actors-v18");
const {
  LIFECYCLE_COMPONENTS,
  governanceBootstrapPrincipal,
  withSimulationStage,
  missingRewardRegistrations
} = require("../../deployment-v18/simulation-v18/contract-scenarios-v18");
const {
  buildSimulationReport,
  renderSimulationMarkdown
} = require("../../deployment-v18/simulation-v18/report-v18");

describe("V18 ABI function simulation harness", function () {
  ...
  it("renders coverage totals, both yield cycles, and decoded errors", function () {
    ...
    const report = buildSimulationReport({
      metadata: { forkBlock: 123, release: "18.9" },
      ledger,
      cycles
    });
