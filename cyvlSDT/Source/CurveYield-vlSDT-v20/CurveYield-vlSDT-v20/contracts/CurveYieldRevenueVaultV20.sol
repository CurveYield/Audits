...
contract CurveYieldRevenueVaultV7 is ERC20, Ownable2Step, ReentrancyGuard {
    ...
    /// @dev Beefy-style realized withdrawal flow with a best-effort pre-withdraw harvest.
    ///      Harvest failure never blocks principal withdrawal; strategy applies the configured withdrawal fee.
