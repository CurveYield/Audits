...
interface IMintableCyvl { function mint(address receiver, uint256 amount) external; }

contract MockLockerForCompounder {
    IERC20 public immutable SDT;
    IMintableCyvl public immutable CYVLSDT;
    uint256 public deposits;
    constructor(address sdt_, address cyvlSdt_) { SDT = IERC20(sdt_); CYVLSDT = IMintableCyvl(cyvlSdt_); }
